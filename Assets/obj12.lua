...
fps = 1
-- gr.animate(scene, 'final/%d.png', 512, 512,
--     17*fps, 16.5, 0.1/fps,  -- numFrames, startTime, timeIncrement
gr.render(scene, 'obj12.png', 512, 512,
    17,  -- timeOfDay
    {-150, 50, -150}, {1, 0, 1}, {0, 1, 0}, 75,
	{0.3, 0.3, 0.3}, {},
